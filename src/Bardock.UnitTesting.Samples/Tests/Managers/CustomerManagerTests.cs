...
using Bardock.UnitTesting.AutoFixture.AutoMapper.Customizations;
using Bardock.UnitTesting.AutoFixture.Customizations;
using Bardock.UnitTesting.AutoFixture.Extensions;
using Bardock.UnitTesting.AutoFixture.Xunit2.Attributes;
using Bardock.UnitTesting.AutoFixture.Xunit2.AutoMapper.Attributes;
using Bardock.UnitTesting.AutoFixture.Xunit2.Data.Attributes;
using Bardock.UnitTesting.Data;
using Bardock.UnitTesting.Data.AutoFixture.Customizations;
using Bardock.UnitTesting.Samples.Fixtures.Attributes;
...
using Bardock.UnitTesting.Samples.SUT.Managers;
using Moq;
using Ploeh.AutoFixture;
using Ploeh.AutoFixture.Xunit2;
using Xunit;

namespace Bardock.UnitTesting.Samples.Tests.Managers
{
    /// <summary>
